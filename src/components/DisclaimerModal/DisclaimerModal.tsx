    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Soju protocol have made
      ...
      return (
        <div>
          <p>Attention SOJU Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with SOJU is SOJU/yCRV
            (Curve yPool tokens)
          </p>
